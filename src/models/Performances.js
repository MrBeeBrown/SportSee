...
class Performances extends Component {
  ...
  constructor(data) {
    ...
    this.data1 = data?.data?.[0]?.value ?? data?.data?.data?.[0]?.value ?? 0;
    this.data2 = data?.data?.[1]?.value ?? data?.data?.data?.[1]?.value ?? 0;
    this.data3 = data?.data?.[2]?.value ?? data?.data?.data?.[2]?.value ?? 0;
    this.data4 = data?.data?.[3]?.value ?? data?.data?.data?.[3]?.value ?? 0;
    this.data5 = data?.data?.[4]?.value ?? data?.data?.data?.[4]?.value ?? 0;
    this.data6 = data?.data?.[5]?.value ?? data?.data?.data?.[5]?.value ?? 0;
  }
